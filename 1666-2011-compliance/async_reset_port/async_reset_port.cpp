...
int sc_main(int argc, char* argv[])
{
  ...
  for (int i = 0; i < 128; i++)
  {
    sc_assert(tops[i]->m->f1);  
    sc_assert(tops[i]->m->f2);  
    sc_assert(tops[i]->m->f3);  
    sc_assert(tops[i]->m->f4);  
    sc_assert(tops[i]->m->f5);  
    sc_assert(tops[i]->m->f6);  
    sc_assert(tops[i]->m->f7);  
    sc_assert(tops[i]->m->f8);  
    sc_assert(tops[i]->m->f9);  
    sc_assert(tops[i]->m->f10);  
    sc_assert(tops[i]->m->f11);  
    sc_assert(tops[i]->m->f12);  
    sc_assert(tops[i]->m->f13);  
    sc_assert(tops[i]->m->f14);  
    sc_assert(tops[i]->m->f15);  
    sc_assert(tops[i]->m->f16);  
    sc_assert(tops[i]->m->f17);  
    sc_assert(tops[i]->m->f18);  
    sc_assert(tops[i]->m->f19);  
    sc_assert(tops[i]->m->f20);  
    sc_assert(tops[i]->m->f21);  
    sc_assert(tops[i]->m->f22);  
    sc_assert(tops[i]->m->f23);  
    sc_assert(tops[i]->m->f24);  
    sc_assert(tops[i]->m->f25);  
    sc_assert(tops[i]->m->f26);  
    sc_assert(tops[i]->m->f28);  
    sc_assert(tops[i]->m->f29);  
    sc_assert(tops[i]->m->f30);  
    sc_assert(tops[i]->m->f31);  
    sc_assert(tops[i]->m->f32);  
    sc_assert(tops[i]->m->f33);  
    sc_assert(tops[i]->m->f34);  
    sc_assert(tops[i]->m->f35);  
    sc_assert(tops[i]->m->f36);  
    sc_assert(tops[i]->m->f37);  
    sc_assert(tops[i]->m->f38);  
  }
