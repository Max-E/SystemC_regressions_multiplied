...
int sc_main(int argc, char* argv[])
{
  ...
  for (int i = 0; i < 128; i++)
  {
    ...
    sc_assert(tops[i]->f8);  
    sc_assert(tops[i]->f9);  
    sc_assert(tops[i]->f11);  
    sc_assert(tops[i]->f12);  
    sc_assert(tops[i]->f13);  
    sc_assert(tops[i]->f14);  
    sc_assert(tops[i]->f15);  
    sc_assert(tops[i]->f16);  
    sc_assert(tops[i]->f17);  
    sc_assert(tops[i]->f18);  
    sc_assert(tops[i]->f19);  
    sc_assert(tops[i]->f20);  
    sc_assert(tops[i]->f21);  
    sc_assert(tops[i]->f22);  
    sc_assert(tops[i]->f23);  
    sc_assert(tops[i]->f24);  
    sc_assert(tops[i]->f25);  
    sc_assert(tops[i]->f26);  
    sc_assert(tops[i]->f28);  
    sc_assert(tops[i]->f29);  
    sc_assert(tops[i]->f30);  
    sc_assert(tops[i]->f31);  
    sc_assert(tops[i]->f32);  
    sc_assert(tops[i]->f33);  
    sc_assert(tops[i]->f34);  
    sc_assert(tops[i]->f35);  
    sc_assert(tops[i]->f36);  
    sc_assert(tops[i]->f37);  
    sc_assert(tops[i]->f38);  
    sc_assert(tops[i]->f39);  
    sc_assert(tops[i]->f40);  
    sc_assert(tops[i]->f41);  
    sc_assert(tops[i]->f42);  
    sc_assert(tops[i]->f43);  
    sc_assert(tops[i]->f44);  
    sc_assert(tops[i]->f45);  
    sc_assert(tops[i]->f46);  
    sc_assert(tops[i]->f47); 
    sc_assert(tops[i]->f48);  
    sc_assert(tops[i]->f49);  
    sc_assert(tops[i]->f50);  
    sc_assert(tops[i]->f51);  
    sc_assert(tops[i]->f52);  
    sc_assert(tops[i]->f53);  
    sc_assert(tops[i]->f54);  
    sc_assert(tops[i]->f55);  
    sc_assert(tops[i]->f56);  
    sc_assert(tops[i]->f57); 
    sc_assert(tops[i]->f58);  
    sc_assert(tops[i]->f59);  
    sc_assert(tops[i]->f60);  
    sc_assert(tops[i]->f61);  
    sc_assert(tops[i]->f62);  
    sc_assert(tops[i]->f63);  
    sc_assert(tops[i]->f64);  
    sc_assert(tops[i]->f65);  
    sc_assert(tops[i]->f66);  
    sc_assert(tops[i]->f67); 
    sc_assert(tops[i]->f68); 
    sc_assert(tops[i]->f69);  
    sc_assert(tops[i]->f70);  
    sc_assert(tops[i]->f71);  
    sc_assert(tops[i]->f72);  
    sc_assert(tops[i]->f73);  
    sc_assert(tops[i]->f74);  
    sc_assert(tops[i]->f75);  
    sc_assert(tops[i]->f76);  
    sc_assert(tops[i]->f77); 
    sc_assert(tops[i]->f78); 
    sc_assert(tops[i]->f79);  
    sc_assert(tops[i]->f80);  
    sc_assert(tops[i]->f81);  
    sc_assert(tops[i]->f82);  
    sc_assert(tops[i]->f83);  
    sc_assert(tops[i]->f84);  
    sc_assert(tops[i]->f85);  
    sc_assert(tops[i]->f86);
  }
